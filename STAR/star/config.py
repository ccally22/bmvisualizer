...
class cfg:
    ...
    path_male_star    = os.path.join(base, '..', '..', 'data', 'body_models', 'star', 'male', 'model.npz')
    # Path to female STAR model
    path_female_star  = os.path.join(base, '..', '..', 'data', 'body_models', 'star', 'female', 'model.npz')
    # Path to neutral STAR model
    path_neutral_star = os.path.join(base, '..', '..', 'data', 'body_models', 'star', 'neutral', 'model.npz')
